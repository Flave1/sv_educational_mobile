...
const TeacherAnnouncementBox = ({ state, dispatch, backgroundColor, navigation, onPress }: any) => {
    ...
    return (
        <Banner
            ...
            buttons={
                <HStack spacing={2}>
                    {/* <Button onPress={onPress} key="learn-more" style={{ backgroundColor: '#2C3E50', }} titleStyle={{ fontSize: 17, textTransform: "capitalize" }} title={'Announcemnts'} compact /> */}
