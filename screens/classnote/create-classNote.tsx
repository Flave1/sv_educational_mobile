...
const ClassNoteCreate = ({ dispatch, state, backgroundColor, navigation, route }: any) => {
    ...
    return (
        <ProtectedTeacher backgroundColor={backgroundColor} currentScreen="ClassNoteCreate">
            <ScrollView>
...
export default ClassNoteCreate;