...
const mapDispatchToProps = (dispatch: any) => {
    return {
        getSharedNoteClasses: (teacherClassNoteId: string) => getSharedNoteClasses(teacherClassNoteId)(dispatch),
        sendClassNotes: (teacherClassNoteId:string, classArray:string[], openOrCloseSendClassnoteModal:any) =>  sendClassNotes(teacherClassNoteId, classArray, openOrCloseSendClassnoteModal)(dispatch),
    }
}
